...
messageStatic = {
    ...
    "request.message.trigger.add.contact": function () {
        return "Bạn đã yêu cầu kết nối đến " + requestProperties.reciverIdentifier;
    },
    "request.message.reciever.add.contact": function () {
        return requestProperties.triggerIdentifier + " đã gửi cho bạn một yêu cầu kết nối";
    },
    "request.message.trigger.add.user.to.channel": function () {
        return "Bạn đã mời " + requestProperties.reciverIdentifier + " tham gia " + requestProperties.channelName;
    },
    "request.message.reciever.add.user.to.channel": function () {
        return requestProperties.triggerIdentifier + " đã mời bạn tham gia " + requestProperties.channelName;
    },
    "request.message.trigger.request.to.channel": function () {
        return "Bạn đã gửi yêu cầu tham gia " + requestProperties.channelName;
    },
    "request.message.reciever.request.to.channel": function () {
        return requestProperties.triggerIdentifier + " đã yêu cầu tham gia cuộc trò chuyện";
    },
    "request.message.reciever.accept.contact": function () {
        return requestProperties.reciverIdentifier + " đã chấp nhận kết nối với bạn";
    },
    "request.message.reciever.accept.to.channel": function () {
        return requestProperties.reciverIdentifier + " đã tham gia cuộc trò chuyện";
    },
    "message.when.created.channel": function () {
