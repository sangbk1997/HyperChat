...
module.exports = function (app) {
    ...
    app.post('/userFriends', function (req, res) {
    ...
    app.get('/userFriends', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.get('/userFriends/:userFriendId', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.post('/userFriends/update', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.post('/userFriends/quickUpdate', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.delete('/userFriends/:userFriendId', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.delete('/userFriends', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
    ...
    app.post('/userFriends/blockUser', function (req, res) {
        res.setHeader('Content-Type', 'application/json');
